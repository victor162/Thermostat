...
//			SET_BIT(ST7789_SPI_CMSIS->CR1, SPI_CR1_SPE);	// ST7789_SPI_CMSIS->CR1 |= SPI_CR1_SPE;
	...
	*((__IO uint8_t *)&ST7789_SPI_CMSIS->DR) = Cmd;
	...
	while (SPI1->SR & SPI_SR_BSY); // раскоментировать для медленной скорости SPI
...
//==============================================================================
// Процедура рисования цифр
//==============================================================================
void ST7789_Digit_7seg(uint16_t x1, uint16_t y1, uint16_t digit, uint16_t color) {

	int16_t deltax = 0, deltay = 0, x = 0, y = 0, x3 = 0, y3 = 0, xinc1 = 0, xinc2 = 0,
		yinc1 = 0, yinc2 = 0, den = 0, num = 0, numadd = 0, numpixels = 0,
		curpixel = 0, color1 = 0;
/*
	deltax = abs(x2 - x1);
...
//			}
//		}
		ST7789_DrawLine(x, y, x3, y3, color1);
		x++;
		y++;
		x3--;
		y3++;
...
// Процедура рисования цифр
//==============================================================================
void ST7789_Digit_7seg_1(uint16_t x1, uint16_t y1, uint16_t digit, uint16_t color) {
